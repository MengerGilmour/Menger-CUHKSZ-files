...
def find_empty_tile():
    """Find the first empty tile in the puzzle grid, assumed to be marked as 0.

    Returns:
        tuple: The (row, column) indices of the first empty tile found.
    """
...
def shuffle_puzzle():
    """Shuffles the puzzle by making 100 random moves of the empty tile."""
    for _ in range(100):
